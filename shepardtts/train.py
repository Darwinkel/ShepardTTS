"""Training pipeline for GTX 3060 12GB."""
...
# Logging parameters
RUN_NAME = "GPT_XTTS_v2.0_Shepard_FT"
...
SPEAKER_REFERENCE = [
    "./ljspeech/wavs/ME3_722117_Femshep.wav"  # speaker reference to be used in training test sentences
]
